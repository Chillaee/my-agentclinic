...
| `agent_ailments`    | `agent_id`, `ailment_id`, `created_at`, `modified_at`, PK `(agent_id, ailment_id)`                                                                                                              | Many-to-many: an agent's presenting complaints  |
| `ailment_therapies` | `ailment_id`, `therapy_id`, `created_at`, `modified_at`, PK `(ailment_id, therapy_id)`                                                                                                          | Many-to-many: recommended therapies per ailment |
...
| Agents <-> ailments             | `agent_ailments` junction with `created_at`/`modified_at`                               | Many-to-many; standard timestamp pair (per tech-stack convention) doubles as "when was this ailment noted" |
